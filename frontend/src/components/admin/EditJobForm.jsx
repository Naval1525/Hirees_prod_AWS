...
// //   const Input = ({ value, onChange, required, name, className = "" }) => (
// //     <input
// //       type="text"
// //       value={value}
// //       onChange={onChange}
...
// //         <div
// //           className="min-h-[38px] px-3 py-2 border border-gray-300 rounded-md cursor-pointer"
// //           onClick={() => setIsOpen(!isOpen)}
// //         >
// //           {value?.length ? (
// //             <div className="flex flex-wrap gap-1">
// //               {value.map(item => (
// //                 <span key={item.value} className="bg-blue-100 px-2 py-1 rounded-md text-sm">
// //                   {item.label}
// //                 </span>
// //               ))}
// //             </div>
...
// //                   value?.some(item => item.value === option.value) ? 'bg-blue-50' : ''
// //                 }`}
...
// //               method: 'GET',  // Optional if default GET method is fine
// //               credentials: 'include',  // This ensures credentials are sent with the request
// //             });
...
// //         <div className="p-6">
// //           <h2 className="text-2xl font-semibold mb-6">Edit Job Posting</h2>
