...
// import Job from "./Job";
// import Navbar from "./shared/Navbar";
// import { Search, MapPin, CalendarDays, Clock, XCircle, Filter, ChevronLeft, ChevronRight, Briefcase, GraduationCap, BookOpen, DollarSign, Award, Zap } from "lucide-react";
// import Footer from "./Footer";
...
//         "JavaScript", "Python", "React", "AWS", "SQL", "Java", "HTML/CSS",
...
//                     if (jobState.filters.skillLevel === "Beginner" && exp <= 2) return true;
//                     if (jobState.filters.skillLevel === "Intermediate" && exp > 2 && exp <= 5) return true;
//                     if (jobState.filters.skillLevel === "Advanced" && exp > 5) return true;
//                     return false;
//                 });
//             }
...
//                 const commonTechSkills = ["JavaScript", "Python", "Java", "React", "AWS", "SQL", "HTML", "CSS", "Node.js"];
...
//             }
//         }
//     }, [jobState.pagination.currentPage, jobState.pagination.pageSize, jobState.allJobs]);
...
//     const isAnyFilterApplied = Object.values(jobState.filters).some(value => {
...
//                                 className={`
//                                     px-3 py-2 rounded-full text-sm border transition-all
//                                     ${jobState.filters.skillsRequired.includes(skill)
//                                         ? "bg-blue-50 border-blue-200 text-blue-700 font-medium"
//                                         : "bg-white border-gray-200 text-gray-600 hover:border-blue-200 hover:bg-blue-50/50"
//                                     }
//                                 `}
